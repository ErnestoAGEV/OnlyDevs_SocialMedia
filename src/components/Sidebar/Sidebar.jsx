...
export const Sidebar = () => {
  ...
  return (
    <div className="h-screen p-2 bg-white dark:bg-bg-dark transition-all duration-300 flex flex-col">
      {/*LOGO*/}
      <div className="h-8 w-8 rounded-full bg-blue-100 text-primary font-bold text-xs flex justify-center items-center m-2">OD</div>
      {/*NAV*/}
        ...
        {links.map((item, index) => {
          return (
            <NavLink
              ...
              to={item.to}
              className={({ isActive }) =>
                `flex items-center gap-3 p-2 rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-primary/10 dark:hover:text-primary transition-all w-full justify-center justify-center sm:justify-start ${
                  isActive
