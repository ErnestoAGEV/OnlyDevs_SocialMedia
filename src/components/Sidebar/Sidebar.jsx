        ...
        {links.map((item, index) => {
          return (
            <NavLink
              ...
              to={item.to}
              className={({ isActive }) =>
                `flex items-center gap-3 p-2 rounded-lg font-semibold hover:bg-gray-100 dark:hover:bg-primary/10 dark:hover:text-primary transition-all w-full justify-center justify-start ${
                  isActive
